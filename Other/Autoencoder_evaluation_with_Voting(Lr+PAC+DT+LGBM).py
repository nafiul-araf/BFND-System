...
vote_model_encoder=joblib.load(r"/content/drive/MyDrive/AutoEncoders/voting_file_encoder.pkl")
print(dir(vote_model_encoder))
...
vote_pred=vote_model_encoder.predict(X_encode)
vote_pred[0:5]
...
accuracy_score(y, vote_pred)


# In[15]:


print(classification_report(y, vote_pred))
