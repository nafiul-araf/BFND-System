...
dt_model.fit(X_train_encode, y_train)


# In[ ]:


dt_model.score(X_train_encode, y_train)


# In[ ]:


dt_model.score(X_test_encode, y_test)
...
import joblib
dt_file=r"/content/drive/MyDrive/AutoEncoders/dt_file_encoder.pkl"
