...
xgb_gpu_model=joblib.load(r"D:\Download\xgb_gpu_file.pkl")


# In[3]:


print(dir(xgb_gpu_model))
...
xgb_gpu_pred=xgb_gpu_model.predict(X)
xgb_gpu_pred
...
accuracy_score(y, xgb_gpu_pred)


# In[10]:


print(classification_report(y, xgb_gpu_pred))


# In[11]:


sns.heatmap(confusion_matrix(y, xgb_gpu_pred), annot=True, fmt='g')
plt.show()
