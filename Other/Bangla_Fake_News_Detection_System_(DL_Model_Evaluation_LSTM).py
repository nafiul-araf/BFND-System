...
model_lstm=load_model(r'/content/gdrive/MyDrive/CSE-400(Project Thesis)/model_lstm.h5')
print(dir(model_lstm))
...
prediction_lstm=model_lstm.predict(X_final)
prediction_lstm
...
accuracy_score(y, prediction_lstm.round())


# In[15]:


print(classification_report(y, prediction_lstm.round()))


# In[16]:


sns.heatmap(confusion_matrix(y, prediction_lstm.round()), annot=True, fmt='g')
plt.show()
