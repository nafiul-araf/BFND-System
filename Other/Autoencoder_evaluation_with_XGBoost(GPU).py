...
xgb_model_encoder=joblib.load(r"D:\Download\xgb_file_encoder.pkl")
print(dir(xgb_model_encoder))
...
xgb_pred=xgb_model_encoder.predict(X_encode)
xgb_pred[0:5]
...
sns.heatmap(confusion_matrix(y, xgb_pred), annot=True, fmt='g')
plt.show()
