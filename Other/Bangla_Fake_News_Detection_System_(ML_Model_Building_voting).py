...
pac_model=joblib.load(r"D:\Download\pac_file.pkl")
print(dir(pac_model))
lr_model=joblib.load(r"D:\Download\lr_file_tfidf.pkl")
print(dir(lr_model))
dt_model=joblib.load(r"D:\Download\dt_file.pkl")
print(dir(dt_model))
lgbm_model=joblib.load(r"D:\Download\lgbm_file_new.pkl")
...
import joblib
vt_file=r"D:\Download\vt_file.pkl"
