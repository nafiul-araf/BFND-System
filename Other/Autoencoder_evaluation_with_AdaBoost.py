...
adb_model_encoder=joblib.load(r"/content/drive/MyDrive/AutoEncoders/adb_file_encoder.pkl")
print(dir(adb_model_encoder))
...
adb_pred=adb_model_encoder.predict(X_encode)
adb_pred[0:5]
...
sns.heatmap(confusion_matrix(y, adb_pred), annot=True, fmt='g')
plt.show()
